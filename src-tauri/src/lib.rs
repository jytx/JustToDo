...
pub fn run() {
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ai::commands::agent::ai_agent_list_sessions,
            ai::commands::agent::ai_agent_history,
            ai::commands::agent::ai_agent_delete_session,
            ai::commands::ai_test_connection,
            commands::task_get_completed_in_range,
            ai::commands::summary::ai_summary,
            ai::commands::scope::ai_summary_scope,
            ai::commands::parse_task::ai_parse_task,
            ai::commands::breakdown::ai_breakdown_task,
            ai::commands::extract::ai_extract_tasks,
            ai::commands::polish::ai_polish_text,
            commands::group_list,
